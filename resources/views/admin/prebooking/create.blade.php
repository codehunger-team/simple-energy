                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="name">Last Name<span class="small text-danger">*</span></label>
                                        <input type="text" id="name" class="form-control" name="name" placeholder="Name" value="">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="email">Contact Number<span class="small text-danger">*</span></label>
                                        <input type="number" id="contact" class="form-control" name="contact" placeholder="example@example.com" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="loginID">Date of Birth<span class="small text-danger">*</span></label>
                                        <input type="text" id="dob" class="form-control" name="dob" placeholder="" value="">
                                    </div>
                                </div>
                            </div>
