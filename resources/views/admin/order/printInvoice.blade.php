            ...
            <div class="margin-side">
                ...
                <div class="invoice-summary">
                    <div class="row">
                        ...
                        <div class="col-invoice">
                            <b>Invoice Date:</b> {{ date('d/m/Y', strtotime($order->updated_at)) }}
                        </div>
                        <div class="col-invoice">
                            <b>Due Date:</b> {{ date('d/m/Y', strtotime($order->updated_at . '+7 days')) }}
                        </div>
                        <div class="col-invoice">
                            <b>Status:</b> {{ ucwords($order->status) }}
                        </div>
                    </div>
                </div>
                <div class="invoice-customer">
                    ...
                    <table cellspacing="0" class="invoice-billing-details">
                        <thead>
                            <tr>
                                <th>Serial Number</th>
                                <th>Model Number/Product Name</th>
                                <th>Color</th>
                                <th>Quantity</th>
                                <th>Rate</th>
                                <th>Amount</th>
                                ...
                                <table class="invoice-footer-billing">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ($order->status == 'unpaid') ? '0' : $order->amount }}</td>
                                        </tr>
                                        <tr>
                                            <td class="summary"><b>Balance</b></td>
                                            <td>{{ ($order->status == 'paid') ? '0' : $order->amount }}</td>
                                        </tr>
                                        <tr>
