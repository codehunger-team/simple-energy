       ...
       <div class="col-lg-12 order-lg-1">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Add New Approval Letter</h6>
                </div>

                <div class="card-body">

                    <form method="POST" action="{{ url('approval-letter') }}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="registration" class="form-control" name="registration" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="file_no" class="form-control" name="file_no"  value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="year" class="form-control" name="year" placeholder="" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="approval_date" class="form-control" name="approval_date" placeholder="" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="Text" id="kyc_status" class="form-control" name="kyc_status" placeholder="" value="">
                                    </div>
                                </div>
                            </div>
