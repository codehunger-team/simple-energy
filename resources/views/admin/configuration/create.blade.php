                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="loginID">Branch Name<span
                                                class="small text-danger">*</span></label>
                                        <input type="text" id="price" class="form-control" name="branch_name" value="{{getConfigValue('branch_name')}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="loginID">IFSC Code<span
                                                class="small text-danger">*</span></label>
                                                <input type="text" id="price" class="form-control" name="ifsc_code" value="{{getConfigValue('ifsc_code')}}">
                                    </div>
                                </div>
                            </div>
                            <!-- Button -->
