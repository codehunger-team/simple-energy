...
<a id="scrollUp" class="call" href="tel:18008900720"
    style="position: fixed;bottom:49%; z-index: 2147483647; display: block;"><i class=" icofont icofont-ui-call"></i></a>
<a id="scrollUp"target="_blank" class="whats" href="https://wa.me/8537014931"
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-4">
                    <div class="logo-small-device">
                        <a href="index-2.html"><img alt="" src="{{ asset('assets/img/logo/logo4.png') }}"></a>
                    </div>
                </div>
                    ...
                    <div class="header-contact-menu-wrapper pl-45">
                        <div class="header-contact">
                            <h5 style="margin-right:40px;">WANT TO TALK WITH US <span
                                    style="color:orange;">18008900720<span></h5>
                        </div>
                        <div class="menu-wrapper text-center">
                            ...
                            <button class="menu-toggle" style="margin-left:40px;">
                                <li><a href="{{ route('book.now') }}"><button class="btn btn-success">Book
                                            Now</button></a></li>
                            </button>
                            ...
                            <div class="main-menu">
                                <nav>
                                    <ul>
                                        ...
                                        <li><a href="{{ route('check.status') }}"><button class="btn btn-success">Check
                                                    Status</button></a></li>
                                    </ul>
                                </nav>
                            </div>
