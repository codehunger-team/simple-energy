...
@section('content')
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">The portable battery has 1.6 KWh of the battery pack and this is removable and you can charge
        ...
        <div class="topic">
            ...
            <p class="answer">The warranty is valid for 3 years from the date of purchase or the first 30000 Km of vehicle
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">Not to worry. Your pre-book would still have got confirmed on our side. From your side, first,
                check your spam folder for the account creation mail as well as the prebook confirmation mail. If they are
                not found in your spam folder, even after 5 minutes, contact care@simpleenergy.in or contact our helpline at
        ...
        <div class="topic">
            <div class="open">
                <h2 class="question">4.Why do I need a license to ride Simple ONE? As I have heard Evs do not need a License
                    to ride them
                </h2><span class="faq-t"></span>
            </div>
            <p class="answer">The electric scooters that run on a 250 W motor and the ones that have a top speed of 25 km/h
                do not require a driver's license or number plate registration. However, the Simple ONE is significantly
                more powerful with a top speed of 105 km/h. Therefore, a driver's license and number plate registration are
        ...
        <div class="topic">
            ...
            <p class="answer">All you need to do is send us an email at care@simpleenergy.in and mention your concern. which
                personal information of yours needs to be updated. Note: The customer needs to send us the email only from
        ...
        <div class="topic">
            ...
            <p class="answer">You can ONLY pre-book the Simple One on our website simpleenergy.in through 4 methods- Paytm,
                Credit/Debit Card, Net Banking, and BHIM/UPI. Beware!! It is notified to the website visitors of
                Simpleenergy.in that there is a scam happening on the internet using the portal/url Simpleenargy.in. Please
                note that Simpleenargy.in is in no manner linked or associated with Simpleenergy Private Limited. Any person
        ...
        <div class="topic">
            ...
            <p class="answer">Customer need to login in our website www.simpleenergy.in and register using Mobile number and
                fill in their details. Email confirmation along with Order ID sent to customer.
                Once intimated to Customer via Phone call followed by email confirmation sent from Sales@simpleenergy.in,
                customer to visit for the tests ride, post-test ride customer to proceed with payment by NEFT, RTGS, Cheque
                ...
                Scooter will be delivered to the customer post completion of registration process, along with an overview of
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">As we have already started the delivery of the Simple ONE we are starting phase-wise. For now,
                the delivery is only happening in Bangalore and once the sales are stable we will be able to move to other
        ...
        <div class="topic">
            ...
            <p class="answer">All our customers will be equally treated and every delivery will be considered on priority
                and make sure we provide the service in smoother.</p>
        </div>
        <div class="topic">
            <div class="open">
                <h2 class="question">3.I do not live in a city where the Simple One is currently sold, but I'd really like
            ...
            <p class="answer">Buying the Simple one and taking it to the city where currently it is not sold may be a
                challenge and also might involve legal concerns. More importantly, we do not have after-sales and roadside
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">Simple One is now available in 2 different color categories. The first segment has 4 initial
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">1st Service will be in 3 months or 2000 Kms whichever comes first and 2nd Service 9 months or
    ...
    <main>
        ...
        <div class="topic">
            ...
            <p class="answer">Not at all. Namma Red is a colour dedicated to our origins and roots, the state of Karnataka.
        ...
        <div class="topic">
            ...
            <p class="answer">The warranty is valid for 3 years from the date of purchase or the first 30000 Km of vehicle
                ...
                and controller and any proven manufacturing defects will be repaired or replaced free of cost by SEPL after
