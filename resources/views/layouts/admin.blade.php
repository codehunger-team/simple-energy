...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/')}}">
            ...
            <div class="sidebar-brand-text mx-3">Revolt</div>
        </a>
        ...
        <li class="nav-item {{ Nav::isRoute('home') }}">
            <a class="nav-link" href="{{ url('prebooking') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>{{ __('Pre Booking') }}</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('home') }}">
            <a class="nav-link" href="{{ url('approval-letter') }}">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span>{{ __('Approval Letter') }}</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('home') }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-danger" href="{{ url('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Logout') }}</a>
